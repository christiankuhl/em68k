...
0xe00376    bsr       sysbase2ram               ; copy sysbase into RAM and patch os_conf to contain os_dosdate
...
*--- Cookies:
            ...
            movea.l   sp,a1
            move.l    #cookieCPU,(a2)
0xe0039a    move      ccr,d0                    ; first exists in the 68010
